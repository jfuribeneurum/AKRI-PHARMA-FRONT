...
(function () {
  ...
  function injectStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .akri-cc-card{margin:0 0 1rem;padding:1rem 1.1rem;background:var(--surface,#fff);border:1px solid var(--line,#E2E8F0);border-radius:20px;box-shadow:0 12px 32px rgba(17,24,39,.06)}
      ...
      .akri-cc-actions{display:flex;gap:.5rem;flex-wrap:wrap;align-items:center}.akri-cc-btn{border:1px solid var(--line,#E2E8F0);background:#fff;color:var(--text,#111827);border-radius:999px;padding:.45rem .85rem;font-weight:700;cursor:pointer;text-decoration:none}.akri-cc-btn.primary{background:var(--primary,#6D28D9);border-color:var(--primary,#6D28D9);color:#fff}
      .akri-cc-tabs{display:flex;flex-wrap:wrap;gap:.55rem;margin-bottom:1rem}.akri-cc-tab{border:1px solid var(--line,#E2E8F0);background:#fff;color:var(--text,#111827);border-radius:999px;padding:.5rem .8rem;font-weight:700;cursor:pointer}.akri-cc-tab.active{background:var(--primary,#6D28D9);border-color:var(--primary,#6D28D9);color:#fff}.akri-cc-tab small{display:inline-block;margin-left:.35rem;font-size:.72rem;opacity:.9}
      .akri-cc-grid{display:grid;grid-template-columns:repeat(4,minmax(180px,1fr));gap:.75rem;margin-bottom:1rem}.akri-cc-tile{border:1px solid var(--line,#E2E8F0);border-radius:14px;padding:.85rem;background:var(--surface-muted,#F8FAFC)}.akri-cc-tile small{display:block;color:var(--muted,#64748B);margin-bottom:.35rem}.akri-cc-tile strong{display:block;font-size:1rem;margin-bottom:.18rem}.akri-cc-tile .meta{color:var(--muted,#64748B);font-size:.84rem;line-height:1.35}
      .akri-cc-content{border:1px solid var(--line,#E2E8F0);border-radius:16px;background:#fff;overflow:hidden}.akri-cc-module-head{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start;padding:1rem;border-bottom:1px solid var(--line,#E2E8F0)}.akri-cc-module-head h4{margin:0 0 .35rem;font-size:1.05rem}.akri-cc-module-head p{margin:0;color:var(--muted,#64748B);font-size:.9rem;line-height:1.45}.akri-cc-iframe{width:100%;border:0;display:block;min-height:980px;background:#fff}.akri-cc-empty{padding:1rem;color:var(--muted,#64748B)}.akri-cc-note{margin-top:.5rem;color:var(--muted,#64748B);font-size:.85rem}
