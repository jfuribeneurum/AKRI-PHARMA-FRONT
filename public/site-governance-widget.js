(function () {
  ...
  function injectStyles(){
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .akri-gov-actions{display:flex;gap:.55rem;flex-wrap:wrap;align-items:center}.akri-gov-btn{border:1px solid var(--line,#E2E8F0);background:var(--surface,#fff);color:var(--text,#111827);border-radius:999px;padding:.5rem .8rem;font-weight:800;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;gap:.45rem}.akri-gov-btn:hover{border-color:var(--primary,#6D28D9);color:var(--primary,#6D28D9)}.akri-gov-btn.alert{background:var(--warning-soft,#FFF7ED);border-color:var(--warning,#FDBA74);color:var(--warning,#9A3412)}.akri-gov-btn.alert .count{display:inline-grid;place-items:center;width:24px;height:24px;border-radius:50%;background:var(--danger,#EF4444);color:#fff;font-size:12px;font-weight:900;animation:akri-pulse 1.4s infinite}
      .akri-gov-dropdown{position:relative}.akri-gov-menu{position:absolute;top:calc(100% + 8px);right:0;min-width:260px;background:var(--surface,#fff);border:1px solid var(--line,#E2E8F0);border-radius:16px;box-shadow:var(--shadow,0 16px 36px rgba(17,24,39,.12));padding:10px;display:none;z-index:1100}.akri-gov-dropdown.open .akri-gov-menu{display:block}.akri-gov-menu button,.akri-gov-menu a{display:flex;width:100%;justify-content:space-between;gap:10px;border:none;background:var(--surface,#fff);border-radius:12px;padding:10px 12px;text-align:left;cursor:pointer;text-decoration:none;color:var(--text,#111827);font:inherit}.akri-gov-menu button:hover,.akri-gov-menu a:hover{background:var(--surface-muted,#F8FAFC)}
      .akri-gov-card{margin:0 0 1rem;padding:1rem 1.1rem;background:var(--surface,#fff);color:var(--text,#111827);border:1px solid var(--line,#E2E8F0);border-radius:18px;box-shadow:var(--shadow,0 16px 40px rgba(17,24,39,.08))}.akri-gov-card h3{margin:0 0 .4rem}.akri-gov-sub,.akri-gov-note{margin:0;color:var(--muted,#64748B);line-height:1.45}.akri-gov-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.75rem;margin-top:1rem}.akri-gov-stat{border:1px solid var(--line,#E2E8F0);border-radius:14px;padding:.85rem;background:var(--surface-muted,#F8FAFC)}.akri-gov-stat small{display:block;color:var(--muted,#64748B);margin-bottom:.3rem}.akri-gov-stat strong{display:block;font-size:1.05rem;color:var(--text,#111827)}
      .akri-gov-modal-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.42);display:flex;align-items:center;justify-content:center;padding:20px;z-index:1200}.akri-gov-modal{width:min(760px,100vw);max-height:90vh;overflow:auto;background:var(--surface,#fff);color:var(--text,#111827);border:1px solid var(--line,#E2E8F0);border-radius:22px;padding:18px;box-shadow:var(--shadow,0 18px 44px rgba(15,23,42,.18))}.akri-gov-modal .list{display:grid;gap:10px;margin-top:14px}.akri-gov-modal .row{display:flex;justify-content:space-between;gap:14px;align-items:center;border:1px solid var(--line,#E2E8F0);border-radius:14px;padding:12px}.akri-gov-modal .toolbar{display:flex;gap:10px;justify-content:flex-end;margin-top:16px}.akri-gov-modal button,.akri-gov-modal a{border:1px solid var(--line,#E2E8F0);background:var(--surface,#fff);border-radius:12px;padding:10px 12px;font:inherit;font-weight:800;cursor:pointer;text-decoration:none;color:var(--text,#111827)}.akri-gov-link{color:var(--primary,#6D28D9);font-weight:800;text-decoration:none}
